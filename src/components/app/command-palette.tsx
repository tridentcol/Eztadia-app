    ...
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="border-border-default bg-surface fixed z-50 overflow-hidden border shadow-2xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 inset-x-3 top-[max(12px,var(--safe-top))] bottom-[max(12px,var(--safe-bottom))] rounded-[14px] sm:inset-auto sm:left-1/2 sm:top-[20vh] sm:bottom-auto sm:w-[640px] sm:max-w-[calc(100vw-32px)] sm:-translate-x-1/2 sm:rounded-[16px] data-[state=closed]:sm:zoom-out-95 data-[state=open]:sm:zoom-in-95"
        >
