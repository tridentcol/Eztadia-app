...
>
> Última actualización: 2026-05-27 — **Step 17a** ✅ (parcial) Foundation visual de tarjetas. Commit `7c212ad` registra schema accounts (+5 cols), catálogo curado de 9 bancos colombianos, `<CardVisual>`, selector cascada en NewAccountDialog, display en /cuentas y /deudas. **Imágenes reales pendientes** de drop en `/public/cards/`. **Commit aún no pusheado** — el usuario decide cuándo. El plan completo de las próximas fases (1-6) vive en `docs/ROADMAP-NEXT.md`.
